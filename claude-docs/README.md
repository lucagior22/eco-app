...
| [`PEDAL.md`](./PEDAL.md) | Funcionamiento técnico de `/pedal`: detección con Gemini, escala verbal de cinco escalones, abstención explícita, manejo de errores y limitaciones abiertas. Incluye como apéndice el detector OpenCV anterior con sus mediciones. |
